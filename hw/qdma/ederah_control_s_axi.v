...
localparam
    ...
    ADDR_IER                = 6'h08,
    ADDR_ISR                = 6'h0c,
    ADDR_NFADATA_CLS_DATA_0 = 6'h10,
    ADDR_NFADATA_CLS_CTRL   = 6'h14,
    ADDR_QUERIES_CLS_DATA_0 = 6'h18,
    ADDR_QUERIES_CLS_CTRL   = 6'h1c,
    ADDR_RESULTS_CLS_DATA_0 = 6'h20,
    ADDR_RESULTS_CLS_CTRL   = 6'h24,
    ADDR_SCALAR03_DATA_0    = 6'h28,
    ADDR_SCALAR03_CTRL      = 6'h2c,
    ADDR_NFA_HASH_DATA_0    = 6'h30,
    ADDR_NFA_HASH_CTRL      = 6'h34,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
        ...
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NFADATA_CLS_DATA_0: begin
                    rdata <= int_nfadata_cls[31:0];
                end
                ADDR_QUERIES_CLS_DATA_0: begin
                    rdata <= int_queries_cls[31:0];
                end
                ADDR_RESULTS_CLS_DATA_0: begin
                    rdata <= int_results_cls[31:0];
                end
                ADDR_SCALAR03_DATA_0: begin
                    rdata <= int_scalar03[31:0];
                end
                ADDR_NFA_HASH_DATA_0: begin
                    rdata <= int_nfa_hash[31:0];
                end
            endcase
        end
    end
