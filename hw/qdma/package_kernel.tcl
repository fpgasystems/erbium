...
::ipx::associate_bus_interfaces -busif "results_stream" -clock "ap_clk" [ipx::current_core]
::ipx::associate_bus_interfaces -busif "inputs_stream" -clock "ap_clk" [ipx::current_core]
