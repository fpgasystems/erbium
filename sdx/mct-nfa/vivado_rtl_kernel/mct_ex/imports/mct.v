...
wire                                ap_idle                       ;
wire                                ap_done                       ;
wire [8-1:0]                        numCriteria                   ;
wire [32-1:0]                       queriesNumCLs                 ;
wire [32-1:0]                       edgesNumCLs                   ;
wire [32-1:0]                       resultNumCLs                  ;
wire [32-1:0]                       extraParam1                   ;
wire [32-1:0]                       extraParam2                   ;
wire [64-1:0]                       nfaPtr                        ;
...
inst_control_s_axi (
  ...
  .queriesNumCLs ( queriesNumCLs         ),
  .edgesNumCLs   ( edgesNumCLs           ),
  .resultNumCLs  ( resultNumCLs          ),
